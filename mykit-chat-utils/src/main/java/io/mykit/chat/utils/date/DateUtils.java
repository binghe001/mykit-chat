package io.mykit.chat.utils.date;
...
public class DateUtils {
	...
	public static void main(String[] args) {
		System.out.println(getWeekByDate("2018-12-23", DATE_FORMAT));
	}
	...
	public static int getWeekByDate(String date, String format){
		Date d = parseStringDateToDate(date, format);
		return getWeekByDate(d);
	}
